...
// from scratch  implement. we can also implement via  java collection  framework
...
public class HashTable {
    ...
    public static void main(String[] args) {
        ...
        //putting key-value pair in HashTable

        table.put(105, "Tom");
        table.put(21, "Harry");
        table.put(31, "Dinesh");
        table.put(45,"Santosh");

        System.out.println(table.remove(45));
        // getting key from HashTable
        System.out.println(table.get(21));
        System.out.println(table.get(31));

        // size of HashTable calculated by NO. of Nodes in HashTable
